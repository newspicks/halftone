...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _image_manipulator_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./image-manipulator.service */
    ...
    var _drop_files_directive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function AppComponent_div_21_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_21_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r3.downloadImage("cropped");
        });
    ...
    function AppComponent_div_59_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_59_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r5.downloadImage("halftone");
        });
    ...
    var AppComponent = /*#__PURE__*/function () {
       ...
       */
      function AppComponent(imgSrv, elementRef) {
      ...
      _createClass(AppComponent, [{
        ...
        key: "attacheFiles",
        value: function attacheFiles(event) {
          var _this = this;
          ...
          try {
            var _loop = function _loop() {
              ...
              reader.onload = function (e) {
                ...
                _this.upload(sendData).subscribe(function (data) {
        ...
        key: "sampleSizeUpdated",
        value: function sampleSizeUpdated() {
          var _this2 = this;

          this.isProcessing = true;
          this.imgSrv.halftone(this.files[0].path, this.croppingPosition, this.width, this.height, this.sampleSize, this.brightness / 100, this.contrast / 100).then(function (res) {
            _this2.halftoneImage = res;
            _this2.isProcessing = false;
          });
        }
      }, {
        key: "brightnessUpdated",
        value: function brightnessUpdated(event) {
          var _this3 = this;

          this.imgSrv.cropImageUpdate(this.originalCropImage, this.brightness / 100, this.contrast / 100).then(function (res) {
            _this3.croppedImage = res;
          })["catch"](function (err) {
            console.error(err);
          });
        }
        ...
        key: "contrastUpdated",
        value: function contrastUpdated(event) {
          var _this4 = this;

          this.imgSrv.cropImageUpdate(this.originalCropImage, this.brightness / 100, this.contrast / 100).then(function (res) {
            _this4.croppedImage = res;
          })["catch"](function (err) {
            console.error(err);
          });
        }
        ...
        value: function downloadImage(type) {
          ...
          var url = window.URL.createObjectURL(this.toBlob(image));
          var link = this.element.querySelector('#img-donwload');
          link.href = url;
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_image_manipulator_service__WEBPACK_IMPORTED_MODULE_2__["ImageManipulatorService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedFiles", function AppComponent_Template_mat_card_content_selectedFiles_10_listener($event) {
            return ctx.attacheFiles($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("imageCropped", function AppComponent_Template_image_cropper_imageCropped_13_listener($event) {
          ...
          })("loadImageFailed", function AppComponent_Template_image_cropper_loadImageFailed_13_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_32_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_mat_slider_ngModelChange_40_listener($event) {
            return ctx.sampleSize = $event;
          })("change", function AppComponent_Template_mat_slider_change_40_listener() {
            return ctx.sampleSizeUpdated();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_mat_slider_ngModelChange_43_listener($event) {
            return ctx.brightness = $event;
          })("change", function AppComponent_Template_mat_slider_change_43_listener($event) {
            return ctx.brightnessUpdated($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_mat_slider_ngModelChange_46_listener($event) {
            return ctx.contrast = $event;
          })("change", function AppComponent_Template_mat_slider_change_46_listener($event) {
            return ctx.contrastUpdated($event);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          type: _image_manipulator_service__WEBPACK_IMPORTED_MODULE_2__["ImageManipulatorService"]
        }, {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _drop_files_directive__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./drop-files.directive */
    "./src/app/drop-files.directive.ts");
    /* harmony import */


    var ngx_image_cropper__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ngx-image-cropper */
    "./node_modules/ngx-image-cropper/__ivy_ngcc__/fesm2015/ngx-image-cropper.js");
    /* harmony import */
    ...
    */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], ngx_image_cropper__WEBPACK_IMPORTED_MODULE_14__["ImageCropperModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["ReactiveFormsModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_2__["DragDropModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_7__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_8__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_9__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_10__["MatListModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButtonModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_12__["MatSliderModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_11__["MatProgressSpinnerModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _drop_files_directive__WEBPACK_IMPORTED_MODULE_13__["DropFilesDirective"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], ngx_image_cropper__WEBPACK_IMPORTED_MODULE_14__["ImageCropperModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["ReactiveFormsModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_2__["DragDropModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_7__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_8__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_9__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_10__["MatListModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButtonModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_12__["MatSliderModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_11__["MatProgressSpinnerModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppDropFilesDirectiveTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DropFilesDirective", function () {
    ...
    var DropFilesDirective = /*#__PURE__*/function () {
      function DropFilesDirective(element) {
        _classCallCheck(this, DropFilesDirective);
      ...
      _createClass(DropFilesDirective, [{
        key: "onChange",
        value: function onChange() {
          var files = this.element.nativeElement.files;
          this.selectedFiles.emit(files); // for (const file of files) {
        ...
        key: "onDropOver",
        value: function onDropOver(event) {
          event.preventDefault();
        }
      }, {
        key: "fileUploadQueue",
    ...
    DropFilesDirective.ɵfac = function DropFilesDirective_Factory(t) {
      return new (t || DropFilesDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]));
    };

    DropFilesDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
      type: DropFilesDirective,
      selectors: [["", "appDropFiles", ""]],
      hostBindings: function DropFilesDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function DropFilesDirective_change_HostBindingHandler() {
            return ctx.onChange();
          })("drop", function DropFilesDirective_drop_HostBindingHandler($event) {
            return ctx.onDrop($event);
          })("dragover", function DropFilesDirective_dragover_HostBindingHandler($event) {
            return ctx.onDropOver($event);
          });
        }
      },
      inputs: {
        fileUploadQueue: ["appDropFiles", "fileUploadQueue"]
      },
      outputs: {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DropFilesDirective, [{
  ...
  /***/
  function srcAppImageManipulatorServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ImageManipulatorService", function () {
      return ImageManipulatorService;
    });
    /* harmony import */
    ...
    var jimp__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jimp__WEBPACK_IMPORTED_MODULE_2__);

    var ImageManipulatorService = /*#__PURE__*/function () {
      function ImageManipulatorService() {
        _classCallCheck(this, ImageManipulatorService);
      }

      _createClass(ImageManipulatorService, [{
        key: "halftone",
        value: function halftone(filepath, position, width, height, sample, brightness, contrast) {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return Object(jimp__WEBPACK_IMPORTED_MODULE_2__["read"])(filepath);

                  case 2:
                    image = _context.sent;
                    image.crop(position.x1, position.y1, position.x2 - position.x1, position.y2 - position.y1).brightness(brightness).contrast(contrast).scan(0, 0, image.bitmap.width, image.bitmap.height, function (x, y, idx) {
                      ...
                      if (y % sample === 0 && x % sample === 0) {
                        ...
                        for (var iy = 0; iy < sample; iy++) {
                          for (var ix = 0; ix < sample; ix++) {
                            var idxi = image.getPixelIndex(x + ix, y + iy); // grey scale値を計算

                            level += Math.round(0.2126 * image.bitmap.data[idxi + 0] + 0.7152 * image.bitmap.data[idxi + 1] + 0.0722 * image.bitmap.data[idxi + 2]);
                          }
                        }

                        radius = sample * (1 - level / (sample * sample * 0xFF));
                        x1 = x + (sample - 1) / 2, y1 = y + (sample - 1) / 2;

                        for (var _iy = 0; _iy < sample; _iy++) {
                          for (var _ix = 0; _ix < sample; _ix++) {
                            var _idxi = image.getPixelIndex(x + _ix, y + _iy); // 半径を計算する。


                            var curR = Math.sqrt(Math.pow(x + _ix - x1, 2) + Math.pow(y + _iy - y1, 2)); // grey scale値を計算

                            if (curR < radius) {
                              image.bitmap.data[_idxi + 0] = 0x00;
                              image.bitmap.data[_idxi + 1] = 0x00;
                              image.bitmap.data[_idxi + 2] = 0x00;
                            } else {
                              image.bitmap.data[_idxi + 0] = 0xff;
                              image.bitmap.data[_idxi + 1] = 0xff;
                              image.bitmap.data[_idxi + 2] = 0xff;
                            }
                          }
                        }
                      }
                    ...
                    return _context.abrupt("return", image.resize(width, height).quality(100).getBase64Async(jimp__WEBPACK_IMPORTED_MODULE_2__["MIME_JPEG"]));
        ...
        key: "cropImageUpdate",
        value: function cropImageUpdate(filepath, brightness, contrast) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    return _context2.abrupt("return", image.brightness(brightness).contrast(contrast).getBase64Async(jimp__WEBPACK_IMPORTED_MODULE_2__["MIME_JPEG"]));
    ...
    ImageManipulatorService.ɵfac = function ImageManipulatorService_Factory(t) {
      return new (t || ImageManipulatorService)();
    };

    ImageManipulatorService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: ImageManipulatorService,
      factory: ImageManipulatorService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ImageManipulatorService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/runner/work/halftone/halftone/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
